...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.3/contracts/token/common/ERC2981.sol"; // for inheriting ERC2981 standard for handling royalties
...
import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.3/contracts/utils/Base64.sol";


import {RestaurantManager} from "./RestaurantManager.sol";
...
contract ReservNFT is ERC721URIStorage, ERC2981, Ownable, ReentrancyGuard {
    ...
    function createReservNFT(
        ...
        RestaurantManager.Drop memory drop = restaurantManager.getDrop(dropId);
        ...
        _setTokenRoyalty(newItemId, drop.royaltiesReceiver, drop.royaltiesBps); //when an NFT is minted this function is called to associate the royalty info with it
