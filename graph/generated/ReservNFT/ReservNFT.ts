...
export class ReservNFT__reservationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  ...
  getReservationTimestamp(): BigInt {
    return this.value2;
  }
}

export class ReservNFT extends ethereum.SmartContract {
  static bind(address: Address): ReservNFT {
    return new ReservNFT("ReservNFT", address);
  }
  ...
  getReservationDetails(
    tokenId: BigInt
  ): ReservNFT__getReservationDetailsResultValue0Struct {
    let result = super.call(
      "getReservationDetails",
      "getReservationDetails(uint256):((uint256,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    );

    return changetype<ReservNFT__getReservationDetailsResultValue0Struct>(
      result[0].toTuple()
    );
  }

  try_getReservationDetails(
    tokenId: BigInt
  ): ethereum.CallResult<ReservNFT__getReservationDetailsResultValue0Struct> {
    let result = super.tryCall(
      "getReservationDetails",
      "getReservationDetails(uint256):((uint256,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<ReservNFT__getReservationDetailsResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  reservations(param0: BigInt): ReservNFT__reservationsResult {
    let result = super.call(
      "reservations",
      "reservations(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new ReservNFT__reservationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_reservations(
    param0: BigInt
  ): ethereum.CallResult<ReservNFT__reservationsResult> {
    let result = super.tryCall(
      "reservations",
      "reservations(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ReservNFT__reservationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
...
export class CreateReservNFTCall extends ethereum.Call {
  get inputs(): CreateReservNFTCall__Inputs {
    return new CreateReservNFTCall__Inputs(this);
  }

  get outputs(): CreateReservNFTCall__Outputs {
    return new CreateReservNFTCall__Outputs(this);
  }
}

export class CreateReservNFTCall__Inputs {
  _call: CreateReservNFTCall;

  constructor(call: CreateReservNFTCall) {
    this._call = call;
  }
...
export class SetRestaurantManagerAddressCall extends ethereum.Call {
  get inputs(): SetRestaurantManagerAddressCall__Inputs {
    return new SetRestaurantManagerAddressCall__Inputs(this);
  }

  get outputs(): SetRestaurantManagerAddressCall__Outputs {
    return new SetRestaurantManagerAddressCall__Outputs(this);
  }
}

export class SetRestaurantManagerAddressCall__Inputs {
  _call: SetRestaurantManagerAddressCall;

  constructor(call: SetRestaurantManagerAddressCall) {
    this._call = call;
  }

  get _restaurantManagerAddress(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetRestaurantManagerAddressCall__Outputs {
  _call: SetRestaurantManagerAddressCall;
