...
contract ReservNFTTest is Test {
    ...
    function setUp() public {
        ...
        address royaltiesReceiver = address(this); // Use the test contract address for now
    ...
    function test_createReservNFT() public payable {
        ...
        / New assertions to check royalty information
        (address receiver, uint256 royaltyAmount) = reservNFT.royaltyInfo(tokenId, 1000); // Check royalty for 1000 wei sale price

    assertEq(receiver, address(this), "Royalty receiver should match expected address");
    assertEq(royaltyAmount, 10, "Royalty amount for 1000 wei sale should be 10 wei"); // Assuming 1% royalty
